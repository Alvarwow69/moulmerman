...
m_selected(false)
{
    m_gameObject.scene().eventManager["Start"].subscribe(this, &moul::SelectionPlayerName::start);
    m_gameObject.scene().eventManager["Update"].subscribe(this, &moul::SelectionPlayerName::update);
}
